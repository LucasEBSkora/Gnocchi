...
namespace EN
{
    ...
    long long LiteralExpr::getInt() const
    {
        return std::get<long long>(value);
    }
    float LiteralExpr::getFloat() const
    {
        return std::get<float>(value);
    }
    double LiteralExpr::getDouble() const
    {
        return std::get<double>(value);
    }
    char LiteralExpr::getChar() const
    {
    ...
    const LiteralVariant &LiteralExpr::get() const
    {
        return value;
    }
    void LiteralExpr::accept(ExprVisitor &visit) const
    {
        visit.visit(*this);
    }
