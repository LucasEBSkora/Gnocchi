...
namespace EN
{
    ...
    void Scope::addEdge(shared_ptr<Edge> e)
    {
        edges.push_back(e);
    }
    const vector<shared_ptr<Vertex>> Scope::getVertices() const
    {
        return vertices;
    }
    bool Scope::hasVertex(string name) const
    {
    ...
    const vector<shared_ptr<Edge>> Scope::getEdges() const
    {
        return edges;
    }
