...
namespace Gnocchi
{
  ...
  const vector<SimpleTokenParam> simpleTokenPairs{
      ...
      {Parser::symbol_kind_type::S_HOLON_BINARY_OP, "<*>", "testIdentifyBinaryHolonOp"},
      {Parser::symbol_kind_type::S_HOLON_UNARY_LEFT_OP, "*>", "testIdentifyUnaryLeftHolonOp"},
      {Parser::symbol_kind_type::S_HOLON_UNARY_RIGHT_OP, "<*", "testIdentifyUnaryRightHolonOp"},
