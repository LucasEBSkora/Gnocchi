...
using namespace std;
using SimpleTokenParam =
    tuple<Gnocchi::Parser::symbol_kind_type, const char *, const char *>;

class SimpleTokensScannerTest
    : public testing::Test,
      public testing::WithParamInterface<SimpleTokenParam> {
public:
  Scanner *obj;
  ...
  void testIdentifySimpleTokenType(Parser::symbol_kind_type type,
                                   const char *token) {
    stringstream stream;
    stream << token;
...
const vector<SimpleTokenParam> simpleTokenPairs{
    ...
    {Parser::symbol_kind_type::S_DECLARE, "declare", "testIdentifyDeclare"},
    {Parser::symbol_kind_type::S_IS, "is", "testIdentifyIs"},
    {Parser::symbol_kind_type::S_VERTEX, "vertex", "testIdentifyVertex"},
    {Parser::symbol_kind_type::S_STATE, "state", "testIdentifyState"},
    ...
    {Parser::symbol_kind_type::S_HOLON_BINARY_OP, "<*>",
...
INSTANTIATE_TEST_SUITE_P(
    testIdentifyPunctiationOperatorsKeywords, SimpleTokensScannerTest,
    testing::ValuesIn(simpleTokenPairs),
    [](const testing::TestParamInfo<SimpleTokenParam> &info) {
