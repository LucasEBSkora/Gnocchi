...
namespace EN
{
    ...
    using TestParam = tuple<Operator, UnaryExpr::Direction, const char *, const char *>;
    ...
    const vector<TestParam> testTuples{
        {Operator::MINUS, UnaryExpr::Direction::LEFT, "-a", "testUnaryMinusToString"},
        {Operator::LOGIC_NOT, UnaryExpr::Direction::LEFT, "!a", "testLogicNotToString"},
        {Operator::BINARY_NOT, UnaryExpr::Direction::LEFT, "~a", "testBinaryNotToString"},
